...
public class EarthquakeCityMapDemo extends PApplet {
	...
	public void setup() {
		...
		// Assume online
//		map = new UnfoldingMap(this, 900, 300, 1200, 700, new Google.GoogleMapProvider());
	map = new UnfoldingMap(this, 400, 200, 700, 500, new OpenStreetMap.OpenStreetMapProvider() );
//	    map = new UnfoldingMap(this, 400, 200, 650, 600, new MBTilesMapProvider(mbTilesString));
