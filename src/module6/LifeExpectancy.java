...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
		size(1050, 850);
		map = new UnfoldingMap(this, 50, 50, 850, 650, new Google.GoogleMapProvider());
	...
	private void shadeCountries() {
		for (Marker marker : countryMarkers) {
			...
			if (lifeExpMap.containsKey(countryId)) {
				...
				marker.setColor(color(124-colorLevel, 100, colorLevel));
			}
			else {
				marker.setColor(color(124, 236, 236));
			}
		}
	}
