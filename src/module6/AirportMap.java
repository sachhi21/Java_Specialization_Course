 ...
 * on a world map.  
 * @author the UC San Diego Intermediate Software Development
 * MOOC team
 *
 */
public class AirportMap extends PApplet {
	...
	public void setup() {
		...
		map = new UnfoldingMap(this, 350, 20, 850, 650);
	...
	private void addKey() {	
		...
		textAlign(LEFT, CENTER);
		textSize(11);
		text("Airport with <", xbase+20, ybase+50);
		text("10 routes", xbase+20, ybase+65);
		text("Airport with >", xbase+20, ybase+80);
		text("10 and < 30 routes", xbase+20, ybase+95);
		text("Airport with >", xbase+20, ybase+110);
